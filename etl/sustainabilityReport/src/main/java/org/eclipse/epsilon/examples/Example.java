...
public class Example {
    ...
    public static void main(String[] args) throws Exception {
        ...
        try {
            ModelVisualizer.render(new File("target.xmi"), new File("target-model-diagram.png"));
            System.out.println("✓ Target model diagram: target-model-diagram.png");
        } catch (Exception e) {
            System.err.println("✗ Error visualizing target model: " + e.getMessage());
            e.printStackTrace();
        }
        System.out.println("Visualization process completed.");
